...
| 分类 | 说明 | 配置数量 | 文档 |
| :--- | :--- | :--- | :--- |
| **通用进阶配置** | 适合 PC、Mac 及普通手机端 | 26 个 | [查看](General_Config/README.md) |
| **Smart 模式 / 路由专用** | 需配合 Smart 魔改内核使用 | 10 个 | [查看](Smart_Mode/README.md) |
...
| **ProxyResource** | 📄 [`Clash_Sample.yaml`](General_Config/iKeLee/Clash_Sample.yaml) | 社区精选配置 | [ProxyResource](https://github.com/luestr/ProxyResource) |
...
| **Share** | 📄 [`redir-host.yaml`](General_Config/Yiteei/redir-host_config.yaml)<br>📄 [`fake-ip.yaml`](General_Config/Yiteei/fake-ip_config.yaml) | 社区精选配置 | [Share](https://github.com/yiteei/Share) |
| **YYDS** | 📄 [`MihomoPro.yaml`](General_Config/666OS/MihomoPro_Config.yaml)<br>📄 [`OneTouch.yaml`](General_Config/666OS/OneTouch_Config.yaml) | 社区精选配置 | [YYDS](https://github.com/666OS/YYDS) |
| **gist** | 📄 [`config.yaml`](General_Config/liuran001/config.yaml) | 社区精选配置 | [gist/raw](https://gist.githubusercontent.com/liuran001/5ca84f7def53c70b554d3f765ff86a33/raw/) |
| **iNg** | 📄 [`ConfigForClash.yaml`](General_Config/fufu/ConfigForClash.yaml) | 社区精选配置 | [iNg](https://github.com/sunfing/iNg) |
| **little** | 📄 fallback 系列 ×5 | 社区精选配置 | [little](https://github.com/liandu2024/little) |
...
| **selfproxy** | 📄 single / multi configs | 社区精选配置 | [selfproxy](https://github.com/yyhhyyyyyy/selfproxy) |
...
| 👤 作者 | 📦 配置清单 | 📝 描述 | 🔗 溯源 |
| :--- | :--- | :--- | :--- |
| **MIHOMO_AIO** | 📄 Smart 系列 ×3 | 社区精选配置 | [MIHOMO_AIO](https://github.com/HenryChiao/MIHOMO_AIO) |
| **YYDS** | 📄 OneSmart 系列 | 社区精选配置 | [YYDS](https://github.com/666OS/YYDS) |
| **little** | 📄 Smart fallback 系列 | 社区精选配置 | [little](https://github.com/liandu2024/little) |
